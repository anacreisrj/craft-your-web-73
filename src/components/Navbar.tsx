    ...
    <nav className="bg-nav text-nav-foreground sticky top-0 z-50">
      <div className="container mx-auto flex items-center justify-between py-4 px-4">
        <a href="#" className="flex items-center gap-3">
          <div className="w-11 h-11 rounded-full bg-primary flex items-center justify-center">
            <span className="text-primary-foreground font-display font-bold text-sm">P&A</span>
          </div>
        ...
        <div className="hidden md:flex items-center gap-8">
          <a href="#instructors" className="text-nav-foreground/90 hover:text-primary transition-colors text-sm font-medium">Meet Your Instructors</a>
      ...
      {mobileOpen && (
        <div className="md:hidden bg-nav border-t border-nav-foreground/10 px-4 pb-4 flex flex-col gap-3">
          <a href="#instructors" className="text-nav-foreground/90 py-2 text-sm" onClick={() => setMobileOpen(false)}>Meet Your Instructors</a>
